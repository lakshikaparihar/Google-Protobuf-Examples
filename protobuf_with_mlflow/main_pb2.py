...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\nmain.proto\"m\n\x10\x46ilePathDownload\x12\x12\n\nproviderid\x18\x01 \x01(\t\x12\x0b\n\x03url\x18\x02 \x01(\t\x12\x0f\n\x07variant\x18\x03 \x01(\t\x12\x15\n\rserialization\x18\x04 \x01(\t\x12\x10\n\x08\x61pi_name\x18\x05 \x01(\t\"\x1f\n\x0e\x46ilePathUpload\x12\r\n\x05\x64path\x18\x01 \x01(\t2<\n\nDownloader\x12.\n\x08\x44ownload\x12\x11.FilePathDownload\x1a\x0f.FilePathUploadb\x06proto3'
)
...
_FILEPATHDOWNLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='providerid', full_name='FilePathDownload.providerid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='url', full_name='FilePathDownload.url', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='variant', full_name='FilePathDownload.variant', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='serialization', full_name='FilePathDownload.serialization', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='api_name', full_name='FilePathDownload.api_name', index=4,
